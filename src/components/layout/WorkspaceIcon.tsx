export function WorkspaceIcon({name}: {name:"select"|"pen"|"eraser"|"connect"|"annotation"|"loom"}) {
  return <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">{
    ...
    name === "eraser" ? <><path d="m4 15 9-9a2.2 2.2 0 0 1 3.1 0l3.9 3.9a2.2 2.2 0 0 1 0 3.1l-6.5 6.5H7Z"/><path d="m12 8 5 5M3 21h18"/></> :
    ...
    <><path d="M4 8C8 2 16 2 20 8c-4 6-12 6-16 0Z"/><path d="M4 16c4-6 12-6 16 0-4 6-12 6-16 0Z"/><path d="M4 8c4 6 12 6 16 0M4 16c4-6 12-6 16 0" opacity=".55"/></>
  }</svg>;
}
